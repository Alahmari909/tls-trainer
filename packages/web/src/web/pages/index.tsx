...
const TLS_SLIDES = [
  {
    src: "/components/ata.webp",
    label: "ATA", fullName: "AZIMUTH TRACKING ANTENNA",
    subtitle: "Tracks the aircraft's azimuth position in real time.",
    features: [
      { icon: "📡", title: "AZIMUTH TRACKING", desc: "Continuously tracks lateral aircraft position." },
      { icon: "🎯", title: "HIGH PRECISION", desc: "Provides accurate course deviation data." },
      { icon: "🔄", title: "REAL-TIME DATA", desc: "Live updates to the TLS processor." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Works with ATA, GS, and GTU units." },
    ],
  },
  {
    src: "/components/asa.webp",
    label: "ASA", fullName: "AZIMUTH SIGNAL ANTENNA",
    subtitle: "Transmits the computed localizer guidance signal to the aircraft.",
    features: [
      { icon: "📶", title: "SIGNAL TRANSMISSION", desc: "Sends ILS-format localizer signals." },
      { icon: "✈️", title: "AIRCRAFT GUIDANCE", desc: "Lateral guidance for approach." },
      { icon: "⚡", title: "LOW LATENCY", desc: "Near-instant signal computation." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Paired with ASA for full guidance." },
    ],
  },
  {
    src: "/components/gs.webp",
    label: "GS", fullName: "GLIDE SLOPE ANTENNA",
    subtitle: "The Glide Slope provides vertical guidance to the aircraft during landing.",
    features: [
      { icon: "🛬", title: "VERTICAL GUIDANCE", desc: "Provides precise glide path information." },
      { icon: "📶", title: "ACCURATE SIGNALING", desc: "Ensures accurate glide path information." },
      { icon: "🛡️", title: "HIGH RELIABILITY", desc: "Built for reliable performance in all conditions." },
      { icon: "📡", title: "INTEGRATED SYSTEM", desc: "Works with the TLS system for safe landings." },
    ],
  },
  {
    src: "/components/loc.webp",
    label: "LOC", fullName: "LOCALIZER ANTENNA",
    subtitle: "Provides lateral course guidance aligned with the runway centerline.",
    features: [
      { icon: "➡️", title: "LATERAL GUIDANCE", desc: "Aligns aircraft with runway centerline." },
      { icon: "📏", title: "COURSE ACCURACY", desc: "Precise DDM-based deviation output." },
      { icon: "🛡️", title: "CAT I CAPABLE", desc: "Meets ICAO CAT I approach standards." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Linked with glide slope for full ILS." },
    ],
  },
  {
    src: "/components/interrogator.webp",
    label: "INTERROGATOR", fullName: "SSR INTERROGATOR UNIT",
    subtitle: "Interrogates aircraft transponders to determine precise 3D position.",
    features: [
      { icon: "📡", title: "SSR INTERROGATION", desc: "Transmits 1030 MHz interrogation pulses." },
      { icon: "🎯", title: "POSITION SENSING", desc: "Computes aircraft range, azimuth, elevation." },
      { icon: "🔄", title: "MODE C/S SUPPORT", desc: "Handles Mode C and Mode S transponders." },
      { icon: "🔗", title: "CORE UNIT", desc: "Heart of the TLS tracking system." },
    ],
  },
  {
    src: "/components/rcu.webp",
    label: "RCU", fullName: "REMOTE CONTROL UNIT",
    subtitle: "Allows operators to monitor and control the TLS system remotely.",
    features: [
      { icon: "🖥️", title: "REMOTE CONTROL", desc: "Full system control from operator station." },
      { icon: "📊", title: "STATUS MONITORING", desc: "Real-time system health and alarms." },
      { icon: "⚙️", title: "CONFIGURATION", desc: "Set approach parameters and calibration." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Connected to all TLS subsystems." },
    ],
  },
  {
    src: "/components/gtu.webp",
    label: "GTU", fullName: "GROUND TRANSCEIVER UNIT",
    subtitle: "Central processing unit that computes and transmits guidance signals.",
    features: [
      { icon: "⚙️", title: "SIGNAL PROCESSING", desc: "Computes ILS deviation from tracked position." },
      { icon: "📡", title: "TRANSMISSION", desc: "Drives LOC and GS antenna outputs." },
      { icon: "🔄", title: "REAL-TIME COMPUTE", desc: "Processes transponder data continuously." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Links all TLS hardware components." },
    ],
  },
  {
    src: "/components/esa.webp",
    label: "ESA", fullName: "ELEVATION SIGNAL ANTENNA",
    subtitle: "Transmits the computed glide slope signal to approaching aircraft.",
    features: [
      { icon: "📐", title: "ELEVATION SIGNAL", desc: "Sends ILS-format glide slope signal." },
      { icon: "🛬", title: "VERTICAL PATH", desc: "Guides aircraft on correct descent angle." },
      { icon: "⚡", title: "FAST RESPONSE", desc: "Low-latency signal to the aircraft." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Paired with ESA for elevation tracking." },
    ],
  },
  {
    src: "/components/calbit.webp",
    label: "CALBIT", fullName: "CALIBRATION BIT TRANSPONDER",
    subtitle: "A fixed transponder used to calibrate and verify TLS tracking accuracy.",
    features: [
      { icon: "🎯", title: "SYSTEM CALIBRATION", desc: "Verifies TLS tracking accuracy on ground." },
      { icon: "📏", title: "REFERENCE POINT", desc: "Known position used for alignment checks." },
      { icon: "✅", title: "VERIFICATION", desc: "Confirms signal integrity before operations." },
      { icon: "🔗", title: "INTEGRATED SYSTEM", desc: "Part of the TLS pre-flight check process." },
    ],
  },
];
...
function TLSSlideshow() {
  ...
  return (
    <div style={{ position: "relative", width: "100%", background: "#000", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <div>
            <div style={{
              ...
              textShadow: "0 0 30px rgba(0,174,239,0.5)",
            }}>{slide.label}</div>
            <div style={{
              fontFamily: "Inter", fontSize: 13, fontWeight: 400,
              color: "rgba(0,174,239,0.9)", marginTop: 4, letterSpacing: "0.02em",
            }}>({slide.fullName})</div>
          </div>
          {/* Counter */}
          <div style={{
            fontFamily: "Inter", fontSize: 9,
            color: "rgba(255,255,255,0.5)", letterSpacing: "0.1em", marginTop: 6,
          }}>{current + 1} / {TLS_SLIDES.length}</div>
        </div>
      ...
      {/* Bottom overlay — features + dots */}
      <div style={{
        position: "absolute", bottom: 0, left: 0, right: 0,
        padding: "50px 0 0",
        background: "linear-gradient(0deg, rgba(0,0,0,0.88) 60%, transparent 100%)",
        opacity: visible ? 1 : 0, transition: "opacity 0.6s ease",
      }}>
        {/* 4 feature icons */}
        <div style={{
          display: "grid", gridTemplateColumns: "repeat(4, 1fr)",
          gap: 0, borderTop: "1px solid rgba(255,255,255,0.08)",
        }}>
          {slide.features.map((f, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                color: "#00AEEF", letterSpacing: "0.07em",
