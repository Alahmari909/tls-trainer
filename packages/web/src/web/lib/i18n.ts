...
export const translations = {
  en: {
    ...
    // ── Chat ────────────────────────────────────────────────────────────────
    chat_title:          'AI INSTRUCTOR',

    // ── Faults ──────────────────────────────────────────────────────────────
    faults_title:        'COMMON FAULTS',
    faults_subtitle:     'TLS FAULT REFERENCE',
    ...
    no_activity:         'Start your first module to begin training',
    switch_lang:         'العربية',
  },
  ...
  ar: {
    ...
    pin_placeholder:     'أدخل رقماً سرياً من 4 أرقام',
    begin_training:      'ابدأ التدريب',
    registering:         'جاري التسجيل...',
    signing_in:          'جاري الدخول...',
    select_name:         'اختر اسمك',
    pin_if_set:          'الرقم السري (إن وُجد)',
    pin_empty:           'اتركه فارغاً إذا لم يكن هناك رقم سري',
    ...
    maintenance:         'الصيانة',
    deployment:          'الحاوية والنشر',
    packing:             'تعليمات التعبئة',
    atc_guide:           'دليل المراقب الجوي',
    ...
    submitted_msg:       'تم تسجيل إجاباتك. سيراجع المدرب نتائجك ويشاركها معك.',
    all_quizzes:         '→ جميع الاختبارات',
    quiz_list_title:     'اختر اختبار الوحدة',
    quiz_completed_label:'تم الاختبار',
    request_retake:      'طلب إعادة الاختبار',
    retake_requesting:   'جاري الإرسال...',
    retake_sent:         '✓ تم الإرسال',
    retake_pending_msg:  'طلب إعادة الاختبار قيد مراجعة المدرب.',
    retake_denied_msg:   'رُفض طلب إعادة الاختبار. تواصل مع مدربك.',
    retake_locked_msg:   'أكملت هذا الاختبار بالفعل. اطلب إعادة الاختبار للمحاولة مجدداً.',
    time_up:             'انتهى الوقت',
    ...
    sound_effects_desc:  'تشغيل أصوات عند إجابات الاختبار',
    notification_sound:  'صوت الإشعارات',
    notification_desc:   'تشغيل صوت تنبيه عند رسائل المدرب',
    vibration:           'الاهتزاز',
    ...
    reference_docs:      'الوثائق المرجعية',
    ...
    // ── Chat ────────────────────────────────────────────────────────────────
    chat_title:          'المدرب الذكي',

    // ── Faults ──────────────────────────────────────────────────────────────
    faults_title:        'الأعطال الشائعة',
    faults_subtitle:     'مرجع أعطال TLS',

    // ── Status ──────────────────────────────────────────────────────────────
    status_title:        'الحالة المباشرة',
    ...
    // ── Extra UI ────────────────────────────────────────────────────────────
    system_intro:        'مقدمة النظام',
    no_activity:         'ابدأ أول وحدة تدريبية للانطلاق',
    switch_lang:         'English',
  },
} as const;
